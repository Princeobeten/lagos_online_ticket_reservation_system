...
export const metadata = {
  title: "Lagos OTRS — Online Ticket Reservation System",
  description:
    "Search routes, reserve a seat, pay online and board with a QR ticket across Lagos State bus, ferry and rail services.",
};
